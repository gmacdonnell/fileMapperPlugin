...
import fileMapper.data.datavo.i2b2result.DataType;
import fileMapper.data.datavo.i2b2result.ResultEnvelopeType;
import fileMapper.data.datavo.i2b2result.ResultType;
import fileMapper.data.datavo.psm.query.AnalysisPluginMetadataResponseType;
import fileMapper.data.datavo.psm.query.AnalysisPluginMetadataTypeType;
import fileMapper.data.datavo.psm.query.CrcXmlResultResponseType;
import fileMapper.data.datavo.psm.query.MasterInstanceResultResponseType;
import fileMapper.data.datavo.psm.query.QueryMasterType;
import fileMapper.data.datavo.psm.query.QueryResultInstanceType;
import fileMapper.data.datavo.psm.query.XmlValueType;
    	...
    	public QueryResultInstanceType extractResultInstance(String response){	
     	...
     	public List extractXMLResult(String response){	
    		...
    		try {
    		    ...
    		    jaxbElement = FileMapperJAXBUtil.getJAXBUtil().unMashallFromString(xmlString);    		    
