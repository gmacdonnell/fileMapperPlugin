...
import edu.fsu.idiginfo.i2b2.fileMapper.data.datavo.i2b2message.InfoType;
...
import edu.fsu.idiginfo.i2b2.fileMapper.data.datavo.i2b2message.MessageTypeType;
...
public class FileMappingMessageEngine {
	...
	public void sendQuery() {
		...
		Thread queryThread = new Thread() {
			...
			public void run() {
				...
				response = FileMapperRequestClient.sendQueryRequestREST(xmlStr);
	...
	//	headerType.setRequestType(PsmRequestTypeType.CRC_QRY_GET_MAP_PLUGIN_REQUIRED_FIELDS);
		...
		fileMapper.data.datavo.psm.query.ObjectFactory psmOf = new fileMapper.data.datavo.psm.query.ObjectFactory();
